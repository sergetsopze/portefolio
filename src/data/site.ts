    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          category: "cloud" as const,
          status: "En cours",
          title: "Outil de PAM — accès à privilèges",
          summary: "Projet personnel en cours de déploiement",
          description:
            "Lab de déploiement d’une solution PAM pour tracer et contrôler les comptes administrateurs (coffre, sessions, moindre privilège). Complète Passbolt (secrets) et l’IAM (identités).",
      ...
      layers: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "PAM (en cours)", highlight: true },
          ],
        },
        {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          category: "cloud" as const,
          status: "In progress",
          title: "PAM platform — privileged access",
          summary: "Personal project currently being deployed",
          description:
            "Lab rollout of a PAM solution to trace and control administrator accounts (vault, sessions, least privilege). Completes Passbolt (secrets) and IAM (identities).",
      ...
      layers: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "IAM", highlight: true },
            { name: "Passbolt", highlight: true },
            { name: "PAM (in progress)", highlight: true },
          ],
        },
        {
          title: "IT operations",
